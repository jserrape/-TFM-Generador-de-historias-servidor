...
with sql.connect("database.db") as con:
    cur = con.cursor()
    cur.execute("INSERT INTO tarea (nombre, descripcion, repetible, periodidad_dia, periodicidad_hora) VALUES (?,?,?,?,?)",('TArea de prueba 1', 'Pastilla del corazon e irte a la mierda.', 'false', '','') )
